package edu.poly.openlab.controller.auth;
import edu.poly.openlab.DTO.AuthenticationResponse;
import edu.poly.openlab.DTO.LoginRequestDTO;
import edu.poly.openlab.DTO.RegisterRequestDTO;
import edu.poly.openlab.entity.User;
import edu.poly.openlab.payload.response.BaseResponse;
import edu.poly.openlab.service.AuthenticationService;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody RegisterRequestDTO request){
        try {
            User user = authenticationService.register(request.getEmail(), request.getPassword(), request.getRole());
